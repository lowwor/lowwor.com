...
在这篇文章里，罗列出了一些有用的快捷键，当然死记硬背是不行的，有两个东西可以帮助我们更快的熟悉AS的快捷键

<!--more-->

 - 记住`ctrl`+`shift`+`a`  这个快捷键，当你忘了别的快捷键的时候，可以用这个来搜索，但是要搜英文才可以，所以，在下面快捷键里也给出英文描述，方便忘记的时候可以直接搜索
 
 - 利用插件Key Promoter来帮助我们学习快捷键，这个插件可以在你做一些操作的时候，会显示该操作的快捷键
 
同时，我们也要注意Windows的快捷键和Mac有所不同，下面只列出了Windows的，Mac用户可自行搜索对应的
